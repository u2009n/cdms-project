...
<table width=100%>
    ...
    <tr>
		<td id="app_name">Check Out Statistics Report:</td>
  </tr>   
</table> 
...
/*  $str='';
    ...
    $_tm=new _time();
    $start_date= $_tm->date_box(
							   array('str_day', 01,31,date("d")), 
							   array('str_month',01, 12, date("m")),
							   array('str_year', date("Y"), date("Y", strtotime($current_date)), date("Y"))
							);
    
    
    
    $end_date= $_tm->date_box(
							   array('end_day', 01,31,date("d")), 
							   array('end_month',01, 12, date("m")),
							   array('end_year', date("Y"), date("Y", strtotime($current_date)), date("Y"))
							);*/
  ...
  ?> 
        ...
        <form  name="serch" method="POST" action="checkout_report.pdf.page.php">

  	
      
        <table width=\"100%\"><tr><th></th><tr></tr>
				...
				<tr>
                    ...
                    <td><input name="str_date" type="text" id="datepicker" /></td>

				   	<td><input type="submit" name="do" value="Search"</td>		                   		
                     
                     
                    <td>Select End Date</td> 			
   			        <td><input name="end_date" type="text" id="datepicker2" /></td>
                    
                    </tr>
                   
		 </table> <table width=\"100%\"><tr><th></th><tr></tr></form>
 ...
 /*echo "<table width=\"100%\"><tbody>
				...
				<tr>
					...
					<td><button onClick=\"search_checkout_stat_rep()\"> Search </button></td>
